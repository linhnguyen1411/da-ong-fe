    ...
    <BookingProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/mon-ngon-moi-ngay" element={<CustomerLayout><DailySpecialPage /></CustomerLayout>} />
          <Route path="/daily-special" element={<Navigate to="/mon-ngon-moi-ngay" replace />} />
          <Route path="/contact" element={<CustomerLayout><ContactPage /></CustomerLayout>} />
          <Route path="/uu-dai" element={<CustomerLayout><PromotionsPage /></CustomerLayout>} />
          <Route path="/tuyen-dung" element={<CustomerLayout><RecruitmentPage /></CustomerLayout>} />
          <Route path="/recruitment" element={<Navigate to="/tuyen-dung" replace />} />
