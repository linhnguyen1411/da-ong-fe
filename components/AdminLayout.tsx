...
import {
  ...
  Mail, DoorOpen, LogOut, Menu, X, ChevronRight, Star, Sparkles, Image, Users, MessageCircle, Briefcase, Tag
} from 'lucide-react';
...
const menuItems = [
  ...
  { path: '/admin/promotions', icon: Tag, label: 'Chương trình ưu đãi' },
  ...
  { path: '/admin/recruitments', icon: Briefcase, label: 'Tuyển dụng' },
