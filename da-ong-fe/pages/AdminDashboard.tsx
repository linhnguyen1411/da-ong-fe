...
import { 
  Loader2, LogOut, Calendar, Users, Mail, DoorOpen, 
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="text-gray-300 text-sm">
              Xin chào, <strong className="text-primary">{adminUser?.name}</strong>
            </span>
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 px-3 py-2 rounded-lg text-sm transition"
            >
